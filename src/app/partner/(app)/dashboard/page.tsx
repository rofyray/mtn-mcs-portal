    ...
    <main className="min-h-screen px-6 py-10">
      ...
      <div className="mx-auto w-full max-w-5xl space-y-8 glass-panel p-6 page-animate">
        <div>
          ...
          <p className="text-sm text-subtext">Overview of your onboarding progress and requests.</p>
        </div>

        <div className="grid gap-4 md:grid-cols-3">
          <div className="card space-y-2">
            <p className="text-xs uppercase tracking-[0.2em] text-subtext">Agents</p>
          ...
          <div className="card space-y-2">
            <p className="text-xs uppercase tracking-[0.2em] text-subtext">Locations</p>
          ...
          <div className="card space-y-2">
            <p className="text-xs uppercase tracking-[0.2em] text-subtext">Forms</p>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="card space-y-2">
            <p className="text-xs uppercase tracking-[0.2em] text-subtext">Requests</p>
          ...
          <div className="card space-y-2">
            <p className="text-xs uppercase tracking-[0.2em] text-subtext">Feedback</p>
            <p className="text-2xl font-semibold">{feedbackItems}</p>
            <p className="text-xs text-subtext">Messages submitted to admins.</p>
          </div>
          <div className="card space-y-2">
            <p className="text-xs uppercase tracking-[0.2em] text-subtext">Quick Actions</p>
